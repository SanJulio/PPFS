...
- `tests/` — pytest suite (361 tests, all passing); `conftest.py` has SQLite schema matching production, including all August 2026 columns
...
- Test suite grew from 228 → 361 tests across this work, all passing.
